    ...
    <div className={`${classShared}`}>
      ...
      >
        ...
        <input
          ref={ref}
          type={typeCustom}
          className={`bg-inherit form-control rounded-0 border-0 px-12px py-10px w-100 h-100 outline-none fw-semibold text-gray-700 fs-14 ${className} ${classNameAdvanced}`}

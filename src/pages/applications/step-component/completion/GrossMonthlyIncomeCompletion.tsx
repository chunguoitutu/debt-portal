...
const GrossMonthlyIncomeCompletion = ({data}: Props) => {
  return (
    <div>
      <p className='text-start pt-4px pt-0 px-0 m-0 fw-semibold text-gray-900 fs-14-line-19'>
        Last month: ${numeral(+data?.monthly_income_1).format('0,0.00')}
      </p>
      <p className='text-start pt-4px pt-0 px-0 m-0 fw-semibold text-gray-900 fs-14-line-19'>
        Last month -1: ${numeral(+data?.monthly_income_2).format('0,0.00')}
      </p>
      <p className='text-start pt-4px pt-0 px-0 m-0 fw-semibold text-gray-900 fs-14  '>

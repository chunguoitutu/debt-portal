  ...
  return (
    <section className='py-50px py-lg-100px'>
      <div className='wrapper d-flex flex-column align-items-center gap-20px gap-lg-72px'>
        ...
        <div className='d-flex flex-column flex-lg-row align-items-center justify-content-between gap-20px'>
          <img
            src={dashboardImg}
            alt='financial institutions'
          ...
          <div className='d-flex flex-column gap-20px gap-lg-24px text-gray-900'>
            <h6 className='content-small m-0 fs-16 fw-normal home-animation fade bot-to-top delay-0-2 text-justify'>
            ...
            <h6 className='content-small m-0 fs-16 fw-normal home-animation fade bot-to-top delay-0-4 text-justify'>

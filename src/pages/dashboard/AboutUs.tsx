...
const AboutUs: FC<DashboardProps> = () => {
  return (
    <section className='dashboard-block about-us py-100px'>
      <div className='container d-flex flex-column flex-lg-row align-items-center gap-30px'>
        <img
          src={dashboardCeo}
          alt='team-img'
          className='about-us__img w-400px mw-100 flex-shrink-0 rounded-circle pt-8px ps-20px object-fit-cover dashboard-animation fade'
        />
        ...
        <div className='d-flex flex-column align-items-center'>
          <img
            src={quote}
            alt='quote'
            className='mb-20px d-block dashboard-animation fade align-self-center align-self-lg-start'
          />
          ...
          <span className='d-inline-block fs-20 text-capitalize mb-20px fw-bold dashboard-animation fade delay-0-2 align-self-start'>
            “Our goal is to create a better and more sustainable tomorrow, for you and your future
            generations.” Empower your future.
          </span>

          <div className='dashboard-animation fade delay-0-4 align-self-start'>
